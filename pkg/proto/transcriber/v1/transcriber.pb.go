...
type WhisperParams struct {
	...
	// No context
	NoContext     *wrapperspb.BoolValue `protobuf:"bytes,16,opt,name=no_context,json=noContext,proto3" json:"no_context,omitempty"`
...
func (x *WhisperParams) GetNoContext() *wrapperspb.BoolValue {
	if x != nil {
		return x.NoContext
	}
	return nil
...
const file_pkg_proto_transcriber_proto_rawDesc = "" +
	"\n" +
	"\x1bpkg/proto/transcriber.proto\x12\x0etranscriber.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x97\b\n" +
	"\rWhisperParams\x12>\n" +
	...
	"\x0einitial_prompt\x18\x0f \x01(\v2\x1c.google.protobuf.StringValueR\rinitialPrompt\x129\n" +
	"\n" +
	"no_context\x18\x10 \x01(\v2\x1a.google.protobuf.BoolValueR\tnoContext\"P\n" +
	"\x04File\x12\x16\n" +
...
var file_pkg_proto_transcriber_proto_depIdxs = []int32{
	...
	5,  // 15: transcriber.v1.WhisperParams.no_context:type_name -> google.protobuf.BoolValue
	1,  // 16: transcriber.v1.TranscribeWavRequest.wav_16k_file:type_name -> transcriber.v1.File
	0,  // 17: transcriber.v1.TranscribeWavRequest.whisper_params:type_name -> transcriber.v1.WhisperParams
	3,  // 18: transcriber.v1.TranscribeWavRequest.transcribe_wav_params:type_name -> transcriber.v1.TranscribeWavParams
	8,  // 19: transcriber.v1.TranscribeWavParams.window_size:type_name -> google.protobuf.Duration
	8,  // 20: transcriber.v1.Segment.start:type_name -> google.protobuf.Duration
	8,  // 21: transcriber.v1.Segment.end:type_name -> google.protobuf.Duration
	2,  // 22: transcriber.v1.Transcriber.TranscribeWav:input_type -> transcriber.v1.TranscribeWavRequest
	4,  // 23: transcriber.v1.Transcriber.TranscribeWav:output_type -> transcriber.v1.Segment
